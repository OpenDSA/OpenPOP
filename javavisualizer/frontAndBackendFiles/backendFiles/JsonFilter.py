...
def generateBackendTrace(jUnitTestFile, filesPath, peruserFilesPath, studentfilename): 
	...
	#command = conf.base_path+"/OpenDSA-server/ODSA-django/openpop/javavisualizer/frontAndBackendFiles/backendFiles/java/bin/java -cp .:"+conf.base_path+"/OpenDSA-server/ODSA-django/openpop/javavisualizer/frontAndBackendFiles/backendFiles/cp:"+conf.base_path+"/OpenDSA-server/ODSA-django/openpop/javavisualizer/frontAndBackendFiles/backendFiles/java/lib:/vagrant/OpenDSA-server/ODSA-django/openpop/javavisualizer/frontAndBackendFiles/backendFiles/cp/javax.json-1.0.jar:"+conf.base_path+"/OpenDSA-server/ODSA-django/openpop/javavisualizer/frontAndBackendFiles/backendFiles/cp/javax.json-1.0.4.jar:"+conf.base_path+"/OpenDSA-server/ODSA-django/openpop/javavisualizer/frontAndBackendFiles/backendFiles/java/lib/:"+conf.base_path+"/OpenDSA-server/ODSA-django/openpop/javavisualizer/frontAndBackendFiles/backendFiles/java/lib/tools.jar:"+conf.base_path+"/OpenDSA-server/ODSA-django/openpop/javavisualizer/frontAndBackendFiles/backendFiles/cp/traceprinter traceprinter.InMemory < "+conf.base_path+"/OpenDSA-server/ODSA-django/openpop/build/pntrtest/pntrequalspntrPROG/Medhaa"
