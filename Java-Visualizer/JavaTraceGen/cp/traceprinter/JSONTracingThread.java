...
private File filteredTrace = new File("WHOO.txt"); 
...
public class JSONTracingThread extends Thread {
    ...
    static UniqueFileWriter blah = new UniqueFileWriter(); 
    ...
    public void run() {
        ...
        try { 
            //PrintStream out = new PrintStream(System.out, true, "UTF-8");
            //out.print(outputString);
            //out.print("WHOOOOOOOOO"); 
	    //blah.writeToFile(outputString); 
        } catch (UnsupportedEncodingException e) {
    ...
    private Thread handleEvent(Event event) {
		...
		try {
			...
			output.add(ep);
			//out.println("lllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll");
			//System.out.println("8888888888888888888888888888888888888888888888888888888"); 
			//blah.writeToFile("WhOOOOO"); 
			steps++;	  
